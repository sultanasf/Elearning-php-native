            ...
            <div class="col-md-9 main">
                ...
                <div class="container-fluid mb-5">
                    <div class="row justify-content-center align-items-center g-2">
                        <div class="col-8">
                            <form method="post" class="bg-light p-3 rounded-3" action="./controller.php">
                                <div class="mb-3">
                                ...
                                <div class="row g-3 mb-2">
                                    <div class="col-4">
                                        ...
                                        <input type="text" class="form-control" name="nrp" id="exampleInputEmail1" value="<?php echo $nip; ?>" aria-describedby="emailHelp" disabled>
                                    </div>
                                    <div class="col-8">
                                        <label for="exampleInputEmail1" class="form-label">Nama</label>
                                        <input type="text" class="form-control" name="nama" id="exampleInputEmail1" value="<?php echo $nama; ?>" aria-describedby="emailHelp">
                                    </div>
                                </div>
                                <div class="container p-3 rounded-3" style="background-color: #abdbe3;">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control" name="username" value="<?php echo $username; ?>" id="exampleInputEmail1" aria-describedby="emailHelp">
                                    </div>
                                    <div class="">
