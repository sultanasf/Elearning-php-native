                    ...
                    <div class="row justify-content-center align-items-center g-2">
                        <div class="col-12">
                            <form method="POST" action="./controller.php">
                                ...
                                FROM nilai, mhs
                                WHERE nilai.idMahasiswa = mhs.id
                                ORDER BY nrp");
                                    while ($d = mysqli_fetch_assoc($data)) {
                                        ...
                                        echo "</td>";
                                        echo "<td>" . $d['indeks'] . "</td>";
                                        echo "<td><button type='button' class='btn btn-sm btn-warning me-1' onclick='enableEdit(this)'>Edit</button>";
                                        echo "<button type='submit' name='submit' class='btn btn-sm btn-primary submit-btn'>Submit</button>";
                                        echo "</td>";
