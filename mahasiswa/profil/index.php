            ...
            <div class="col-md-3 fixed-sidebar">
                <nav class="">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item ms-4 ps-1 aktif">
                            ...
                            <form method="post" class="bg-light p-3 rounded-3" action="./controller.php" enctype="multipart/form-data">
                                ...
                                <div class="row g-3 mb-2">
                                    <div class="col-4">
                                        ...
                                        <input disabled type="text" class="form-control" value="<?php echo $d["nrp"] ?>" id="exampleInputEmail1" aria-describedby="emailHelp">
                                    </div>
                                    <div class="col-8">
                                ...
                                <div class="row g-0 mb-2">
                                    <div class="col-6">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" <?php if ($d["jenisKelamin"] == "Laki-laki") echo "checked"; ?> name="jenisKelamin" id="" value="Laki-laki">
                                            <label class="form-check-label" for="">Laki-laki</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" <?php if ($d["jenisKelamin"] == "Perempuan") echo "checked"; ?> name="jenisKelamin" id="" value="Perempuan">
                                            <label class="form-check-label" for="">Perempuan</label>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <label for="exampleInputEmail1" class="form-label">Prodi</label>
                                        <input type="text" class="form-control" name="prodi" value="<?php echo $d["prodi"] ?>" id="exampleInputEmail1" aria-describedby="emailHelp">
                                    </div>
                                </div>
                                <div class="">
                                    <label for="exampleInputEmail1" class="form-label">Foto lama:</label>
                                    <a href="../images/<?php echo $d["namaFile"] ?>" class="btn btn-sm btn-primary" target="_blank">Lihat</a>
                                    <a href="../images/<?php echo $d["namaFile"] ?>" class="btn btn-sm btn-primary" download>Download</a>
                                </div>
                                <div class="mb-3">
                                    <input type="hidden" name="old-image" value="<?php echo $d["namaFile"] ?>">
                                    <label for="exampleInputEmail1" class="form-label">Foto baru:</label>
                                    <input type="file" class="form-control" name="new-image" id="exampleInputEmail1" aria-describedby="emailHelp">
                                </div>
                                <div class="container p-3 rounded-3" style="background-color: #abdbe3;">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo $d["username"] ?>" name="username" id="exampleInputEmail1" aria-describedby="emailHelp">
                                    </div>
                                    <div class="">
